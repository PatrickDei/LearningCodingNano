...
#pragma mark misc
	...
	/** @brief Get randomly generatet UUID value */
	static const std::string generateUUID(void);

	/** @brief Get the NSBundle version */
	static const std::string bundleVersion(void);
    ...
    //added by Tomislav
    static std::string bundleVer;
    static std::string deviceName;
    static cocos2d::extension::CCAlertViewDelegate* delegate_m;
