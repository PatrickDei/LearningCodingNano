...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_org_cocos2dx_lib_Cocos2dxHelper_nativeSetObbPath(JNIEnv*  env, jobject thiz, jstring apkPath) {
    	g_obbPath = JniHelper::jstring2string(apkPath);
    }
