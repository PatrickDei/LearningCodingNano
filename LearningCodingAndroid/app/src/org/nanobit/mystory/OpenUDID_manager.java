...
public class OpenUDID_manager implements ServiceConnection{
	...
	//private final static boolean LOG = StardroidConfig.DEBUG; //Display or not debug message
	...
	private static void storeOpenUDID() {
	 ...
	 */
	private static void generateOpenUDID() {		
		Context context = Cocos2dxActivity.getContext();
		//Try to get the ANDROID_ID
		OpenUDID = Secure.getString(context.getContentResolver(), Secure.ANDROID_ID); 
	...
	public static String getOpenUDID() {
		//if (!mInitialized) //
		//Log.v("OpenUDID", "OpenUDID " +OpenUDID );
		return  OpenUDID;
	}
	...
	//public static native void udidSet();
}
